        ...
        <div className="hero-content">
          <div className="hero-title-design">
            ...
            <div className="hero-title&desc" data-aos="fade">
              <h1 className="hero-title">Vicinity Map</h1>
              <p className="hero-text">
                Locate PUP Parañaque with ease. This map provides a clear view
                of the campus and its surrounding area, helping visitors
                navigate nearby landmarks, main roads, and transportation
                routes.
              </p>
            </div>
          </div>
